...
function Create()
	...
	this.Tooltip = "tooltip_EmptyStaffGrave1"
end
...
function JobComplete_DigHole()
	...
	nearbyCoffins = Find(this,"GraveCoffinStaffLoaded",3)
	for thatCoffin, dist in pairs(nearbyCoffins) do
		if thatCoffin.Id.i == this.Slot3.i then
			...
			newGrave = Object.Spawn("GraveStaffUnderConstruction2", this.Pos.x,this.Pos.y)
			
			newCoffin = Object.Spawn("GraveCoffinStaffLoaded2", myCoffin.Pos.x,myCoffin.Pos.y)
